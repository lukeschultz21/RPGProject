...
public class Battleship
{
    ...
    {
        System.out.println("Battlship by Luke Schultz");  
        
        System.out.println("\nUser Setup");
        Player userPlayer = new Player();
        setup(userPlayer);
        System.out.println("Computer setup, hit enter to continue");
        reader.nextLine();
        reader.nextLine();
        ...
        while(true)
        {
            ...
            {
                System.out.println("Computer hit and the user has lossed!");
                break;
            }
            else if (computer.playerGrid.hasLost())
            {
                System.out.println("User hit and the computer has lossed!");
                break;
            }
    ...
    private static void compMakeGuess(Player comp, Player user)
    {
        ...
        if (user.playerGrid.hasShip(row, col))
        {
            ...
            System.out.println("COMP HIT AT " + switchInt(row) + switchCol(col));
        }
        else
        {
            comp.oppGrid.markMiss(row, col);
            user.playerGrid.markMiss(row, col);
            System.out.println("COMP MISS AT " + switchInt(row) + switchCol(col));
        }
    ...
    private static String switchInt(int val)
    {
        String toReturn = "Z";
        switch (val)
        {
    ...
    private static int switchCol(int val)
    {
        int toReturn = -1;
        switch (val)
        {
